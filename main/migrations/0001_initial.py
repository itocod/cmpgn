# Generated by Django 5.0.6 on 2024-07-06 16:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='campaign_files/')),
                ('category', models.CharField(choices=[('Awareness', 'Awareness'), ('Fundraising', 'Fundraising'), ('Volunteering', 'Volunteering'), ('Education', 'Education'), ('Healthcare', 'Healthcare'), ('Environment', 'Environment'), ('Animal Welfare', 'Animal Welfare'), ('Arts and Culture', 'Arts and Culture'), ('Sports', 'Sports'), ('Technology', 'Technology'), ('Community Development', 'Community Development'), ('Human Rights', 'Human Rights'), ('Emergency Relief', 'Emergency Relief'), ('Political Campaigns', 'Political Campaigns'), ('Business and Entrepreneurship', 'Business and Entrepreneurship'), ('Religious', 'Religious'), ('Other', 'Other')], default='Awareness', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='profile_pics/pp.png', upload_to='profile_pics')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='allowed_campaigns', to='main.profile'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='user',
